...
public class LobbyCreateUI : MonoBehaviour {
    ...
    private void Awake() {
        ...
        gameModeButton.onClick.AddListener(() => {
            switch (gameMode) {
                default:
                case LobbyManager.GameMode.Cielo_Carmesi:
                    gameMode = LobbyManager.GameMode.Bosque_Encantado;
                    break;
                case LobbyManager.GameMode.Bosque_Encantado:
                    gameMode = LobbyManager.GameMode.Cielo_Carmesi;
                    break;
            }
            UpdateText();
        });
